...
****************************************************************************/
	...
	$mainconfigstring .= "mysqli_connect('" . $servername . "', '" . $dbuser . "', '" . $dbpass1 . "', 'rp');\n";
	$mainconfigstring .= "	}\n";
	...
	$adminconfig1 .= '   $db_name="rp"; // Database name' . "\n";
	$adminconfig1 .= '   $tbl_name="users";' . "\n";
	$adminconfig1 .= '   //Connect to server and select databse.' . "\n";
	$adminconfig1 .= '   mysqli_connect("$host", "$username", "$password", "$db_name")or die("cannot connect to server");' . "\n";
	$adminconfig1 .= '?>';

	//Admin config file - /admin/configp.php
	$adminconfig2 = "<?php\n";
	$adminconfig2 .= '  $dbhost="' . "{$servername}" . '";' . "\n";
	$adminconfig2 .= '	$dbname ="rp";' . "\n";
